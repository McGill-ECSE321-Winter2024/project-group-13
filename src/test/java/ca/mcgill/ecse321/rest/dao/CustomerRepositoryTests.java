...
public class CustomerRepositoryTests {
    ...
    /**
     * @author Rafael Reis
     * Test goal: create a customer successfully.
     * This test creates a customer, saves it to the database,
     * and asserts that the retrieved customer from the database is not null.
     */
    @Test
    public void testCreateCustomer() {
        ...
        customer = customerRepository.findCustomerByEmail(email); // Get customer from database by email.

        // Assert that customer is not null (i.e. customer was created and added to the database successfully)
        assertNotNull(customer);
    }

    /**
     * @author Rafael Reis
     * Test goal: create a customer and read its data from the database successfully.
     * This test creates a customer, saves it to the database, retrieves it by id
    ...
    /**
     * @author Rafael Reis
     * Test goal: create a customer and read its data from the database successfully using the phone number as identifier.
     * This test creates a customer, saves it to the database, retrieves it by phone number
     * and asserts that the retrieved data related to this customer from the database is correct.
     */
    @Test
    public void testReadCustomerByPhoneNumber() {
        ...
        customerRepository.save(customer); // Save customer to database.
        customer = customerRepository.findCustomerByPhoneNumber(phoneNumber); // Get customer from database by phone number.
    ...
    /**
     * @author Rafael Reis
     * Test goal: update the customer password
     * In this test we create a customer and save it to the database.
     * Then we change the customer password and make sure the database reflects that change.
     */
    @Test
    ...
    /**
     * @author Rafael Reis
     * Test goal: update the customer email
     * In this test we create a customer and save it to the database.
     * Then we change the customer email and make sure the database reflects that change.
     */
    @Test
    ...
    /**
     * @author Rafael Reis
     * Test goal: update the customer name
     * In this test we create a customer and save it to the database.
     * Then we change the customer name and make sure the database reflects that change.
     */
    @Test
    ...
    /**
     * @author Rafael Reis
     * Test goal: update the customer phone number
     * In this test we create a customer and save it to the database.
     * Then we change the customer phone number and make sure the database reflects that change.
     */
    @Test
    ...
    /**
     * @author Rafael Reis
     * Test goal: delete the customer by id
     * In this test we create a customer and save it to the database.
     * Then we delete the customer and make sure the database reflects that change.
     */
    @Test
    ...
    /**
     * @author Rafael Reis
     * Test goal: delete the customer by email
     * In this test we create a customer and save it to the database.
     * Then we delete the customer and make sure the database reflects that change.
     */
    @Test
    ...
    /**
     * @author Rafael Reis
     * Test goal: check for duplicate customer email.
     * In this test we create a customer and save it to the database.
     * Then we try to create another customer with the same email.
    ...
    public void testCustomerDuplicateEmail() {
        ...
        customer1 = customerRepository.findCustomerByEmail(email1); // Get customer from database by email.
        ...
        assertEquals(email2, customer2.getEmail()); // the email should still be email2, i.e. the change was not allowed
    }

    /**
     * @author Rafael Reis
     * Test goal: check for duplicate customer phone number.
     * In this test we create a customer and save it to the database.
     * Then we try to create another customer with the same phone number.
     * We should detect this and not allow it.
     */
    @Test
    public void testCustomerDuplicatePhoneNumber() {
        ...
        customer2.setEmail(phoneNumber1); // Attempt to change the phone number of customer2 to be that of customer1;

        assertEquals(phoneNumber2, customer2.getPhoneNumber()); // the phone number should still be email2, i.e. the change was not allowed
    }
    ...
    /**
     * @author Rafael Reis
     * Set attributes of the customer parameter.
    ...
    /**
     * @author Rafael Reis
     * Perform JUnit tests to see whether the customer attributes are correct or not.
     ...
     */
    private void checkAttributes(Customer customer, String name, String phoneNumber, String email, String password) {
