    ...
    />
      <div className="space-y-12 p-10">
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-gray-900/10 pb-12 md:grid-cols-3 align-items-right">
          <div>
          <h2 className="text-base font-semibold leading-7 text-gray-900">Create a new course</h2>
          </div>
          ...
          <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
            ...
            <br/><div className="sm:col-span-4">
            <div>
      ...
      <div className="relative mt-2 rounded-md shadow-sm">
        ...
        <div className="absolute inset-y-0 right-0 flex items-center">
          ...
          >
            ...
            <div className="sm:col-span-4">
              <label htmlFor="city" className="block text-sm font-medium leading-6 text-gray-900 pb-2">
                Select a start and end date
              </label>
              <Datepicker minDate={
                new Date()
              }   value={dateRange} onChange={handleValueChange} />
