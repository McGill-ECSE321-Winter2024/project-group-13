...
export default function ViewCourse() {
    ...
    return course ? (
        <div className="bg-white p-5">
            ...
            <div>
                <strong>Start Date:</strong> {moment(course.courseStartDate).format('YYYY-MM-DD')}
                <strong>End Date:</strong> {moment(course.courseEndDate).format('YYYY-MM-DD')}
                ...
                <table className="min-w-full divide-y divide-gray-200">
                    ...
                    {getEvents().map((event, index) => (
                        <tr key={index}>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                                {event.title.replace(course.name + ' ', '')}
                            </td>
                        </tr>
                    ))}
                    </tbody>
